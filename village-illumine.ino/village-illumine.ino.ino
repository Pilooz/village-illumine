...
#define NUM_LEDS3  92 //80 //60 //40 //12 // 432 
#define NB_MAISONS3 22 //19 // 15 //6 // 95 
...
void initVillage() {
maisons[0] = initMaison(3, 15, 1, 0, 3);
maisons[1] = initMaison(3, 15, 2, 4, 7);
maisons[2] = initMaison(3, 15, 3, 8, 11);
maisons[3] = initMaison(3, 15, 4, 12, 15);
maisons[4] = initMaison(3, 13, 1, 16, 19);
maisons[5] = initMaison(3, 13, 2, 20, 23);
maisons[6] = initMaison(3, 13, 3, 24, 27);
maisons[7] = initMaison(3, 13, 4, 28, 31);
maisons[8] = initMaison(3, 13, 5, 32, 35);
maisons[9] = initMaison(3, 13, 6, 36, 39);
maisons[10] = initMaison(3, 12, 1, 40, 43);
maisons[11] = initMaison(3, 12, 2, 44, 47);
maisons[12] = initMaison(3, 12, 3, 48, 51);
maisons[13] = initMaison(3, 1, 1, 52, 59);
maisons[14] = initMaison(3, 2, 1, 60, 63);
maisons[15] = initMaison(3, 2, 2, 64, 67);
maisons[16] = initMaison(3, 2, 3, 68, 71);
maisons[17] = initMaison(3, 2, 4, 72, 75);
maisons[18] = initMaison(3, 2, 5, 76, 79);
maisons[19] = initMaison(3, 3, 1, 80, 83);
maisons[20] = initMaison(3, 3, 2, 84, 87);
maisons[21] = initMaison(3, 3, 3, 88, 91);
}
